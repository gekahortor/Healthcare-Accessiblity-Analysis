...
def _(acc_roads, fac_gpd, ox):
    ...
    return acc_roads_proj, fac_gpd_proj


@app.cell
def _(acc_roads_proj, ox):
...
@app.cell
def _(fac_gpd_proj, ox, roads_s_t):
...
def _(nx, ox):
    ...
    return (make_isochrone,)


@app.cell
def _(fac_gpd_proj, make_isochrone, roads_s_t):
    all_isochrones_data = []
    ...
    return (all_isochrones_data,)


@app.cell
def _(all_isochrones_data, gpd):
...
def _(gdf_accra, pop_data):
    ...
    return Ghana_pop, boundary_accra_proj


@app.cell
def _(Ghana_pop, boundary_accra_proj):
...
@app.cell
def _(accra_pop, isochrone_poly):
...
def _(accra_pop, isochrone_poly):
    ...
    return (pop_outside_isochrone,)


@app.cell
def _(accra_pop, pop_outside_isochrone, pop_within_isochrone):
    ...
    return total_pop_outside_isochrone, total_pop_within_isochrone


@app.cell
def _(total_pop_outside_isochrone, total_pop_within_isochrone):
